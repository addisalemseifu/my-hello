...
# 📖 [my-hello] <a name="about-project"></a>

**my-hello** is a fullstack web application using webpack,react,ruby on rails which generates random greetings.
...
```bash
  git chttps://github.com/addisalemseifu/my-hello.git
```
